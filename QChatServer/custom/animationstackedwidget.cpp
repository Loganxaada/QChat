    ...
    ,m_previousIndex(0)
{
    ...
    connect(m_animation, &QPropertyAnimation::valueChanged, this,&AnimationStackedWidget::on_valueChanged);
    connect(m_animation, &QPropertyAnimation::finished,this,&AnimationStackedWidget::on_animationFinished);
}
...
void AnimationStackedWidget::setLength(int length, AnimationStackedWidget::AnimationType type)
{
    switch(m_type = type)
    {
    case BottomToTop :
...
void AnimationStackedWidget::on_valueChanged(const QVariant &value)
{
    m_currentValue = value.toFloat();
    update();
}

void AnimationStackedWidget::on_animationFinished()
{
    m_currentValue = 0;
    m_isAnimating = false;
